...
x = HuffmanObject(SKULLTAG_FREQS)

w = bytes([4,83,19,241,82,127,51,190,179,87, 91, 122, 154, 27, 187, 158, 123, 2, 122, 186, 154, 187, 186, 254, 122, 124, 20, 82, 190, 242, 139, 212, 152, 35, 254, 215, 18, 208, 210, 211, 28, 215, 220, 116, 195, 198, 184, 63, 237, 146, 184, 5, 15, 142 ,203 ,39 ,5])
decoded = x.decode(w);

for i in range(len(decoded)):
    print(decoded[i], end = ', ');

""" 119, 93, 86, 0, 242, 134, 166, 4, 51, 46, 48, 45, 114, 49, 55, 48, 57, 48, 49, 45, 49, 49, 52, 48, 32, 111, 110, 32, 76, 105, 110, 117, 120, 32, 52, 46, 57, 46, 48, 45, 54, 45, 97, 109, 100, 54, 52, 0, 1, 0, 0, 0, 68, 79, 79, 77, 32, 50, 0 """